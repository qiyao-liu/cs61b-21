...
public class IntListExercises {
    ...
    public static boolean squarePrimes(IntList lst) {
        ...
        if (currElemIsPrime) {
            squarePrimes(lst.rest); // Execute the recursive call regardless of the current element being prime
            return true; // Return true if the current element is prime
        } else {
            return squarePrimes(lst.rest); // Return the result of the recursive call for non-prime elements
        }
